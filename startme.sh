...
echo "Enter api crypt key / apicryptkey'ini yaz:"
read apicryptkey
...
define('url_global_server' , 'http://$TORHOSTNAME');

define('key' , '$apicryptkey');

define('server' , 'localhost');

define('db', 'bot');

define('user', 'cerberusroot');

define('passwd', 'cerberus');
...
EOM
echo "$EDITX" > /var/www/html/conf.php
...
EOM
echo "$EDITXX" > /sysres/source/gate/conf.php
...
EOM
echo "$EDITFL" > /sysres/source/restapi/db.php

echo "Completed!"
echo "If have a issue,"
echo "Contact : GaSXV2#2605"